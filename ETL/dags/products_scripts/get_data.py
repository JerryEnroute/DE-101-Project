...
def main():
    ...
    directory = pathlib.Path(AIRFLOW_HOME, "dags", "files", "input", "products")
    input_files = os.listdir(f"{directory}/")
    destination_files = []
    for input_file in input_files:
        destination_filename = "products_etl.csv"
        ...
        df = pd.read_csv(os.path.join(AIRFLOW_HOME, "dags", "files", "input", "products", input_file))
